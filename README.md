...
2020-11-24 16:08:32,545 DEBUG Received response(xid=1): ('{"weight": 0, "server": "127.0.0.1:80"}', ZnodeStat(czxid=312, mzxid=312, ctime=1606205156399, mtime=1606205156399, version=0, cversion=0, aversion=0, ephemeralOwner=72057605710938198, dataLength=39, numChildren=0, pzxid=312))
Out[2]: '{"weight": 0, "server": "127.0.0.1:80"}'
```
